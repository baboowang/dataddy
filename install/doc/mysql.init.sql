...
DROP TABLE IF EXISTS `menuitem`;
 CREATE TABLE `menuitem` (
  ...
  `mail_receiver` text NULL COMMENT '邮件发送对象',
  `mail_memo` text NULL COMMENT '邮件备注',
  `settings` text NULL COMMENT '其他配置信息',
